...
% INPUTS:   - neuralAmp: a value that scales the amplitude of the fMRI data
...
function simulfMRI2(neuralAmp,HIRF,varargin)
...
parse(p,neuralAmp,HIRF,varargin{:});
...
blockDuration = 24;  % duration in seconds on 1 block
